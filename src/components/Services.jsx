      ...
      <div className="container-custom">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <SplitHeading before="My" highlight="Services" level="h2" />
          </motion.div>
          <motion.p
            variants={itemVariants}
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-8">
            ...
            {[
              ...
              >
                <div className="flex-shrink-0 w-12 h-12 bg-primary-600 rounded-lg flex items-center justify-center text-muted font-bold group-hover:scale-110 transition-transform duration-300">
                  {process.step}
                </div>
                <div>
